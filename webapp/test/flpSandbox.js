		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comexampletimesheet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampletimesheet-display": {
								"semanticObject": "comexampletimesheet",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.timesheet",
									"url": sap.ui.require.toUrl("com/example/timesheet")
								}
							}
						}
					}
