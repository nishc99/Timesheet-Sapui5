...
sap.ui.define(["sap/ui/base/Object"], function (UI5Object) {
	...
	var sMockdataPath = jQuery.sap.getModulePath("com.example.timesheet") + "/model/api/mockdata/";
	...
	return UI5Object.extend("com.example.timesheet.model.api.provider.MockProvider", {
		_iDelay: 1000,
		_oData: {},
				...
				function (resolve, reject) {
					this._onDataReady().then(
						function () { 
							debugger;
								// STANDARD EXECUTION
								this._oData.purchaseorder = this._oData.timesheet.find(
